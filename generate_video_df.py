...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", type=int,
                        default=1)  # 20250422 pftq: Batch functionality to avoid reloading the model each video
    ...
    print(f"Rank {local_rank}: {width}x{height} | Image Input: " + str(image != None) + " | Video Input: " + str(
        video != None))
    ...
    print("Finished initializing pipe at " + time.strftime("%Y-%m-%d_%H-%M-%S", time.localtime()) + " (" + str(
